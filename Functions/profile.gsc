...
UnlockAchievements(player)
{
    if(player != self)
    {
        self iPrintlnBold("^2" + CleanName(player getName()) + ":^7 Unlock Achievements ^2Started");
        self iPrintlnBold("You'll Be Notified When Complete");
    }
    
    player iPrintlnBold("Unlock Achievements ^2Started");
    player iPrintlnBold("You'll Be Notified When Complete");
    ...
    for(a = 0; a < achievements.size; a++)
    {
        ...
        wait 1; //Needed for ps4 use
    }

    if(player != self)
        self iPrintlnBold("^2" + CleanName(player getName()) + ":^7 Unlock Achievements ^2Complete");
    
    player iPrintlnBold("Unlock Achievements ^2Complete");
}
